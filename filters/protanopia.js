...
filterID.innerHTML = '<svg id="colorblind-filters" style="display: none"> <defs> <filter id="protanopia"> <feColorMatrix type="matrix" values="49.111,-48.111,0,0,0 -62,63,0,0,0 19.794,-20.113,1.319,0,0 0,0,0,1,0" in="SourceGraphic" /> </filter> </defs> </svg>';
