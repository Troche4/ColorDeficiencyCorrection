...
filterID.innerHTML = '<svg id="colorblind-filters" style="display: none"> <defs> <filter id="deuteranopia"> <feColorMatrix type="matrix" values="-4,5,0,0,0 9.333,-8.333,0,0,0 -4,3.571,1.429,0,0 0,0,0,1,0" in="SourceGraphic" /> </filter> </defs> </svg>';
